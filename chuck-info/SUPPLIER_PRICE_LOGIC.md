...
### 🏗️ File Structure (Schema)

#### A. XML Structure (Price)

| Node Tag             | Description                  | Used?  | Example          |
| :------------------- | :--------------------------- | :----- | :--------------- |
| `<Id>`             | SKU (Varenummer)             | ✅ Yes | `6311713`      |
| `<UnitGrossPrice>` | **Bruttopris** (Gross) | ✅ Yes | `231.20`       |
| `<DiscountCode>`   | Rabattkode (Link to TXT)     | ✅ Yes | `TNN`          |
| `<Description>`    | Product Name                 | ❌ No  | `Ror deler...` |
| `<Unit>`           | Sales Unit                   | ❌ No  | `STK`          |
...
| :-------- | :--------------------------- | :----- | :---------------- |
| 0         | Type                         | ❌ No  | `RL`            |
| 1         | **Code** (Matches XML) | ✅ Yes | `TNN`           |
| 2         | **Discount %**         | ✅ Yes | `79.00`         |
| 3         | Description                  | ❌ No  | `RØRGRUPPE...` |
...
### 📂 Source File: `dahl_price.xlsx`

### 🏗️ Complete Column Map (Schema)
...
| :-------------- | :------------------ | :------------------------------- | :-------------- | :--------------------- |
| **0 (A)** | **Varenr**    | **SKU**                    | ✅**Yes** | `4560068`            |
| 1 (B)           | Varetekst           | Product Name                     | ❌ No           | `FLEXIAVLØP...`     |
| 2 (C)           | Bruttopris          | Gross Price                      | ❌ No           | `106`                |
| 3 (D)           | Rabatt              | Discount Amount (Cash)           | ❌ No           | `38.16`              |
| **4 (E)** | **Nettopris** | **Net Price** (Final Cost) | ✅**Yes** | **`67.84`**    |
| 5 (F)           | Rabatt %            | Discount Percentage              | ❌ No           | `36`                 |
| 6 (G)           | Enhet               | Unit (UoM)                       | ❌ No           | `BLS` (Blister)      |
| 7 (H)           | Pakning             | Pack Type                        | ❌ No           | `CA`                 |
| 8 (I)           | Varegruppe          | Product Group                    | ❌ No           | `BD BLISTER`         |
| 9 (J)           | MinBest             | Minimum Order Qty                | ❌ No           | `1`                  |
| 10 (K)          | Sektor              | Sector                           | ❌ No           | `VVS`                |
| 11 (L)          | Dato                | Price Date                       | ❌ No           | `01.01.2026`         |
...
### 📂 Source File: `heidenreich_price.txt`

### 🏗️ Fixed-Width Map (Visual Ruler)
...
| :----------- | :----------- | :----- | :---------------------- | :-------------- | :--------------- |
| **0**  | **11** | 11     | **SKU** (Raw)     | ✅**Yes** | `15007036998`  |
| 11           | 13           | 2      | Spacer                  | ❌ No           |                  |
| 13           | 63           | 50     | Description             | ❌ No           | `1904 VOSS...` |
| 63           | 71           | 8      | Unit (Enhet)            | ❌ No           | `STK     `     |
| 71           | 79           | 8      | Quantity                | ❌ No           | `  1.00`       |
| **84** | **92** | 8      | **Price** (Gross) | ✅**Yes** | ` 2734.50`     |
| 93           | 98           | 5      | Disc Grp (Ty)           | ❌ No           | `HKH0B `       |
...
## 4. 🗃️ APPENDIX: Full Data Verification Tables
...
| :-------------------- | :------------------------- | :--------------------------------------------------------------------------------------- | :------------------------------------------------------------- |
| **Ahlsell**     | `Gross * (1 - Disc/100)` | `minus_value = round(float(price) * disc / 100, 2)<br>``final = price - minus_value` | ✅ Verified in `price/Ahlsell_price/price.py`                |
| **Dahl**        | Use Column E (Index 4)     | `column_e = df[4]`                                                                     | ✅ Verified in `price/dahl_price/entry_point.py`             |
| **Heidenreich** | Extract pos 84-92          | `extract_value(line, start=84, end=92)`                                                | ✅ Verified in `price/Heidenreich_price/heidenreichprice.py` |
